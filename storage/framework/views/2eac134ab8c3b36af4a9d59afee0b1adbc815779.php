...
<?php echo $__env->make('/partials/navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-md-6">
                <div class="home-img-session d-flex justify-content-center align-items-center">
                    <div class="home-ad-event-pic">
                        <img src="<?php echo e(url("/asserts/eventpic3.png")); ?>" alt="Event-pic">
                    </div>
                    <div class="home-ad-left-right-arrow">
                        <img src="<?php echo e(url("/asserts/left-right-arrow.jpg")); ?>" alt="Left-right-arrow">
                    </div>
                    <div class="home-ad-ves_logo">
                        <img src="<?php echo e(url("/asserts/VES_logo.png")); ?>" alt="VES-logo">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="my-all-socierty-div d-flex justify-content-center">
        <div class="row my-society-content container">
            ...
            <div class="col-6 col-md-3 d-flex justify-content-center">
                <a href="<?php echo e(url('society',$society->name)); ?>">
                    <div class="CSI-society d-flex flex-column">
                        <img src="<?php echo e(url("/asserts/$society->image ")); ?>">
                        <h4><?php echo e($society->name); ?></h4>
                    </div>
                </a>
            </div>
    ...
    <div class="MY-on-going-evenets-session">
        <div class="row">
            ...
            <?php else: ?>
                <?php for($i=0; $i < sizeof($ongoing_events); $i++): ?>
                <div class="col-12 col-md-4">
                    <div class="each-event-container">
                        <div class="img-session">
                            <img src="<?php echo e(url("storage/event_images/".$ongoing_events[$i]->profile_image)); ?>" alt="event-img">
                        </div>
                        <div class="content-session">
                            <div class="upper-content d-flex flex-column">
                                <p class="main-title"><?php echo e($ongoing_events[$i]->name); ?></p>
                                <p class="short-desc"><?php echo e($ongoing_events[$i]->short_description); ?></p>
                                <?php
                                ...
                                <p class="guest-text"><span>Guest:</span>
                                        ...
                                        <?php for($j=0 ; $j < sizeof($guests_ids) ; $j++): ?>
                                            <?php
                                            ...
                                            <?php endif; ?>
                                        <?php endfor; ?>
                                        <?php echo e($guest_data); ?>

                                </p>
                                <div class="date-time-div d-flex justify-content-start align-items-center">
                                    <p class="date-session"><span><i class="far fa-calendar-alt"></i></span><?php echo e($ongoing_events[$i]->date); ?></p>
                                    <p><span><i class="far fa-clock"></i></span> <?php echo e($ongoing_events[$i]->time); ?></p>
                                </div>
                                <div class="register-button-div">
                                    <?php if(in_array($ongoing_events[$i]->id  , $req_arr)): ?>
                                        <a id="each-event-register-button" class="btn btn-md btn-success" href="/event/<?php echo e($ongoing_events[$i]->id); ?>">Register</a>
                                    <?php else: ?>
                                        <a id="each-event-register-button" class="btn btn-md btn-primary" href="/event/<?php echo e($ongoing_events[$i]->id); ?>">Register</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
    ...
    <div class="MY-on-going-evenets-session">
            <div class="row">
                ...
                <?php else: ?>
                    <?php for($i = 0; $i<sizeof($upcoming_events); $i++): ?>
                        <div class="col-12 col-md-4">
                            <div class="each-event-container">
                                <div class="img-session">
                                    <img src="<?php echo e(url("storage/event_images/".$upcoming_events[$i]->profile_image )); ?>" alt="event-img">
                                </div>
                                <div class="content-session">
                                    <div class="upper-content d-flex flex-column">
                                        <p class="main-title"><?php echo e($upcoming_events[$i]->name); ?></p>
                                        <p class="short-desc"><?php echo e($upcoming_events[$i]->short_description); ?></p>
                                        <?php
                                        ...
                                        <div class="date-time-div d-flex justify-content-start align-items-center">
                                            <p class="date-session"><span><i class="far fa-calendar-alt"></i></span><?php echo e($upcoming_events[$i]->date); ?></p>
                                            <p><span><i class="far fa-clock"></i></span> <?php echo e($upcoming_events[$i]->time); ?></p>
                                        </div>
                                        <div class="register-button-div">
                                            <?php if(in_array($upcoming_events[$i]->id  , $req_arr)): ?>
                                            <a id="each-event-register-button" class="btn btn-md btn-success" href="event/<?php echo e($upcoming_events[$i]->id); ?>">Register</a>
                                            <?php else: ?>
                                                <a id="each-event-register-button" class="btn btn-md btn-primary" href="event/<?php echo e($upcoming_events[$i]->id); ?>">Register</a>
                                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\vesitevents\resources\views/index.blade.php ENDPATH**/ ?>